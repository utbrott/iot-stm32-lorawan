...
static LoRaMacStatus_t AddMacCommand( uint8_t cmd, uint8_t p1, uint8_t p2 )
{
    ...
    DBG_PRINTF("\t^^ MAC CMD Added: ");
    switch( cmd )
    {
        case MOTE_MAC_LINK_CHECK_REQ:
            DBG_PRINTF("MOTE_MAC_LINK_CHECK_REQ\n\r");
        ...
        case MOTE_MAC_LINK_ADR_ANS:
            DBG_PRINTF("MOTE_MAC_LINK_ADR_ANS\n\r");
        ...
        case MOTE_MAC_DUTY_CYCLE_ANS:
            DBG_PRINTF("MOTE_MAC_DUTY_CYCLE_ANS\n\r");
            if( MacCommandsBufferIndex < bufLen )
            {
                MacCommandsBuffer[MacCommandsBufferIndex++] = cmd;
        ...
        case MOTE_MAC_RX_PARAM_SETUP_ANS:
            DBG_PRINTF("MOTE_MAC_RX_PARAM_SETUP_ANS\n\r");
            if( MacCommandsBufferIndex < ( bufLen - 1 ) )
            {
                MacCommandsBuffer[MacCommandsBufferIndex++] = cmd;
        ...
        case MOTE_MAC_DEV_STATUS_ANS:
            DBG_PRINTF("MOTE_MAC_DEV_STATUS_ANS\n\r");
        ...
        case MOTE_MAC_NEW_CHANNEL_ANS:
            DBG_PRINTF("MOTE_MAC_NEW_CHANNEL_ANS\n\r");
            if( MacCommandsBufferIndex < ( bufLen - 1 ) )
            {
                MacCommandsBuffer[MacCommandsBufferIndex++] = cmd;
        ...
        case MOTE_MAC_RX_TIMING_SETUP_ANS:
            DBG_PRINTF("MOTE_MAC_RX_TIMING_SETUP_ANS\n\r");
            if( MacCommandsBufferIndex < bufLen )
            {
                MacCommandsBuffer[MacCommandsBufferIndex++] = cmd;
                // No payload for this answer
        ...
        case MOTE_MAC_TX_PARAM_SETUP_ANS:
            DBG_PRINTF("MOTE_MAC_TX_PARAM_SETUP_ANS\n\r");
            if( MacCommandsBufferIndex < bufLen )
            {
                MacCommandsBuffer[MacCommandsBufferIndex++] = cmd;
                // No payload for this answer
        ...
        case MOTE_MAC_DL_CHANNEL_ANS:
            DBG_PRINTF("MOTE_MAC_DL_CHANNEL_ANS\n\r");
            if( MacCommandsBufferIndex < bufLen )
            {
                MacCommandsBuffer[MacCommandsBufferIndex++] = cmd;
...
static void ProcessMacCommands( uint8_t *payload, uint8_t macIndex, uint8_t commandsSize, uint8_t snr )
{
    ...
    while( macIndex < commandsSize )
    {
        ...
        DBG_PRINTF("\t~~ MAC CMD Received: ");
        switch( payload[macIndex++] )
        {
            case SRV_MAC_LINK_CHECK_ANS:
                DBG_PRINTF("SRV_MAC_LINK_CHECK_ANS\n\r"); 
                MlmeConfirm.Status = LORAMAC_EVENT_INFO_STATUS_OK;
            ...
            case SRV_MAC_LINK_ADR_REQ:
                {
                    DBG_PRINTF("SRV_MAC_LINK_ADR_REQ\n\r");
            ...
            case SRV_MAC_DUTY_CYCLE_REQ:
                DBG_PRINTF("SRV_MAC_DUTY_CYCLE_REQ\n\r");
            ...
            case SRV_MAC_RX_PARAM_SETUP_REQ:
                {
                    DBG_PRINTF("SRV_MAC_RX_PARAM_SETUP_REQ\n\r");
            ...
            case SRV_MAC_DEV_STATUS_REQ:
                {
                    DBG_PRINTF("SRV_MAC_DEV_STATUS_REQ\n\r");
            ...
            case SRV_MAC_NEW_CHANNEL_REQ:
                {
                    DBG_PRINTF("SRV_MAC_NEW_CHANNEL_REQ\n\r");
            ...
            case SRV_MAC_RX_TIMING_SETUP_REQ:
                {
                    DBG_PRINTF("SRV_MAC_RX_TIMING_SETUP_REQ\n\r");
            ...
            case SRV_MAC_TX_PARAM_SETUP_REQ:
                {
                    DBG_PRINTF("SRV_MAC_TX_PARAM_SETUP_REQ\n\r");
            ...
            case SRV_MAC_DL_CHANNEL_REQ:
                {
                    DBG_PRINTF("SRV_MAC_DL_CHANNEL_REQ\n\r");
...
void Print_Lora_Settings( void )
{
  ...
  switch( mibReq.Param.Class )
  {
    ...
    case CLASS_C:
      ...
      break;
    default:
      DBG_PRINTF("\tClass: UNKNOWN!\n\r");
      break;            
  }        
  
  getPhy.Attribute = PHY_DEF_MAX_EIRP;
  phyParam = RegionGetPhyParam( LoRaMacRegion, &getPhy );
  DBG_PRINTF("\tTX Max EIRP: %.2f dBm\n\r", phyParam.fValue);
  
  getPhy.Attribute = PHY_DEF_UPLINK_DWELL_TIME;
  phyParam = RegionGetPhyParam( LoRaMacRegion, &getPhy );
  DBG_PRINTF("\tUplink Dwell Time: %s\n\r", ((phyParam.Value == 0)?"Unlimited":"Limited to 400ms"));

  getPhy.Attribute = PHY_DEF_DOWNLINK_DWELL_TIME;
  phyParam = RegionGetPhyParam( LoRaMacRegion, &getPhy );
  DBG_PRINTF("\tDownlink Dwell Time: %s\n\r", ((phyParam.Value == 0)?"Unlimited":"Limited to 400ms"));
 
  getPhy.Attribute = PHY_DUTY_CYCLE;
  phyParam = RegionGetPhyParam( LoRaMacRegion, &getPhy );
  DBG_PRINTF("\tDuty Cycle: %s\n\r", ((phyParam.Value == 0)?"Disabled":"Enabled"));  
